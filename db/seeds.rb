...
# 350z = Car.create(model: "350Z", manufacturer: "Nissan", address: "SE21 8AL", price: 120)
impreza = Car.create!(model: "Impreza", manufacturer: "Subaru", address: "SE21 8AL", price: 150, user: user_3)

# file = File.open("app/assets/images/rx8.JPG")
# rx8.photos.attach(io: file, filename: photo, content_type: "image/JPG")
